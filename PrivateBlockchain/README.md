...
- Some of the libraries or npm modules you will use are:
    ...
    - "hex2ascii": "0.0.3",
    - "morgan": "^1.9.1"
    For other library, use `npm install <npm_module_name>`
...
2. `BlockchainController.js` file. It contains the routes of the REST Api. Those are the methods that expose the urls you need to call when make a request to the application.
...
We need to install all the libraries and module dependencies, to do that: open a terminal and run the command `npm install`

**( To be able to work on this project you will need to have installed in your computer Node.js and npm )**
